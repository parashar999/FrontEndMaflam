...
const TermsAndConditionsPage  = () => {
  ...
  const { termsConditionScreenDetails, loading: aboutLoading, error: aboutError } = useContext(TermsConditionContext);

  useEffect(() => {
    if (termsConditionScreenDetails) {
      console.log("TermsCondition Screen Details:", termsConditionScreenDetails);
    }
