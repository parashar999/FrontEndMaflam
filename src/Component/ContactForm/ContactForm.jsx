...
const ContactForm = () => {
  ...
  console.log("hgbj",contactUs2ContextDetails)
  ...
  console.log("hgbjhgj",contactDetailsSec3)
      ...
      <div className={styles.formContainer}>
        ...
        <form className={styles.contactForm}>
          ...
          <div className={styles.inputGroup}>
            ...
            <div className={styles.radioGroup}>
              {jobRoleCategories.map((role, index) => (
                <button key={index} type="button" className={styles.radioButton}>
                  {role}
                </button>
              ))}
            </div>
          ...
          <div className={styles.inputGroup}>
            ...
            <input type="file" id="resume" onChange={(e) => handleFileUpload(e, setResume)} />
          </div>

          {/* Portfolio */}
          <div className={styles.inputGroup}>
            <label htmlFor="portfolio">{portfolioTitle}</label>
            <input type="file" id="portfolio" onChange={(e) => handleFileUpload(e, setPortfolio)} />
          </div>
