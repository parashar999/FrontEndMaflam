      ...
      <div className={styles.container}>
        <div className={styles.footerColumns}>
          ...
          <div className={styles.footerColumn}>
            ...
            <a href="#" aria-label="Instagram"><svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="33" height="33" rx="16.5" fill="#39FFFB"/>
            ...
            <path d="M16.5095 12.0762C14.083 12.0762 12.1133 14.0459 12.1133 16.4724C12.1133 18.8988 14.083 20.8686 16.5095 20.8686C18.936 20.8686 20.9057 18.8988 20.9057 16.4724C20.9057 14.0459 18.936 12.0762 16.5095 12.0762ZM16.5095 19.4037C14.8946 19.4037 13.5781 18.0873 13.5781 16.4724C13.5781 14.8574 14.8946 13.541 16.5095 13.541C18.1244 13.541 19.4408 14.8574 19.4408 16.4724C19.4408 18.0873 18.1244 19.4037 16.5095 19.4037Z" fill="#061C2B"/>
            <path d="M21.1976 12.6623C20.7131 12.6623 20.3184 12.2675 20.3184 11.783C20.3184 11.2986 20.7131 10.9038 21.1976 10.9038C21.6821 10.9038 22.0768 11.2986 22.0768 11.783C22.0768 12.2675 21.6821 12.6623 21.1976 12.6623Z" fill="#061C2B"/>
            </g>
            <defs>
            ...
            <rect width="17" height="17" fill="white" transform="translate(8 7.97266)"/>
              ...
              <li className={styles.socialIcons}>
                ...
                <a href="#" aria-label="YouTube"><svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="33" height="33" rx="16.5" fill="#39FFFB"/>
